...
ColorPalette.prototype.onClick = function(event)
{
    ...
    x = event.clientX - rectangle.left; // position x sur la page - la position x du canvas sur la page
    y = event.clientY - rectangle.top; // position y sur la page - la position y du canvas sur la page
