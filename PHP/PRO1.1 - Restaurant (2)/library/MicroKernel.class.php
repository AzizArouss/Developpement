...
//echo '<pre>';
//var_dump(array("script" => __FILE__, "ligne" => __LINE__, '$class:', $class));
//echo '</pre>';
...
echo '</pre>';*/
        ...
        {
/*echo '<pre>';
var_dump(array("script" => __FILE__, "ligne" => __LINE__, '$filename:'=>$filename));
echo '</pre>';*/
...
//echo '<pre>';
//var_dump(array("script" => __FILE__, "ligne" => __LINE__, '$this->applicationPath/controllers$requestPath: '=> "$this->applicationPath/controllers$requestPath"));
//echo '</pre>';
