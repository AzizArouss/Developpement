...
// echo '<pre>';
// var_dump(array("script" => __FILE__, "ligne" => __LINE__, 'filters:'=> $filters));
...
//echo '<pre>';
//var_dump(array("script" => __FILE__, "ligne" => __LINE__, '$this->viewData[\'variables\']:'=>$this->viewData['variables']));
//echo '</pre>';
...
//echo '</pre>';
        ...
        if(array_key_exists('_form', $this->viewData['variables']) == true)
        {
            ...
            {
//echo '<pre>';
//var_dump(array("script" => __FILE__, "ligne" => __LINE__, 'Yes, get the form object'));
//echo '</pre>';
...
//echo '<pre>';
//var_dump(array("script" => __FILE__, "ligne" => __LINE__, 'array_key_exists(\'_raw_template\', $this->viewData[\'variables\']): '=>array_key_exists('_raw_template', $this->viewData['variables'])));
//echo '</pre>';
...
//echo '<pre>';
//var_dump(array("script" => __FILE__, "ligne" => __LINE__, '$controllerClass: '.$controllerClass));
//echo '</pre>';
...
//echo '<pre>';
//var_dump(array("script" => __FILE__, "ligne" => __LINE__, '$this->viewData: '=>$this->viewData));
//echo '</pre>';
